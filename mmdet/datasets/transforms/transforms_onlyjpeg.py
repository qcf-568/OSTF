...
class Texture(BaseTransform):
    def __init__(self, prob=1.0, bathres=2048, revjpegpath='', q1=75, q2=100) -> None:
        assert 0 <= prob <= 1
        self.q1 = q1
        self.q2 = q2
        self.p = prob
    ...
    def transform(self, results: dict) -> dict:
        ...
        for bi,box in enumerate(results['gt_bboxes']):
            ...
            newbw = (ymax-ymin)
            newbh = (xmax-xmin)
            if ((this_canvas1[x1:x2,y1:y2].sum()==0) and (random.uniform(0,1)<0.5)):
                ...
                if random.uniform(0,1)<0.5:
                    ...
                    this_canvas1[x1:x2,y1:y2] = 1
                flag = False
            if ((this_canvas2[x1:x2,y1:y2].sum()==0) and (random.uniform(0,1)<0.5)):
