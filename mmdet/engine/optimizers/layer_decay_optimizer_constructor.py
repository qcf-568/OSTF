...
def get_num_layer_layer_wise_hornet(var_name, num_max_layer=12):
    ...
    def add_params(self, params: List[dict], module: nn.Module,
        ...
        for name, param in module.named_parameters():
            ...
            if 'layer_wise' in decay_type:
                ...
                elif 'HorNet' in module.backbone.__class__.__name__:
                    layer_id = get_num_layer_layer_wise_hornet(
                        name, self.paramwise_cfg.get('num_layers'))
                    logger.info(f'set param {name} as id {layer_id}')
                elif 'Intern'  in module.backbone.__class__.__name__:
