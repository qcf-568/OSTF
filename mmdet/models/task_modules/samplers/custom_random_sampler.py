...
from ..assigners import CustomAssignResult
...
class CustomRandomSampler(BaseSampler):
    ...
    def _sample_pos(self, assign_result: CustomAssignResult, num_expected: int,
    ...
    def _sample_neg(self, assign_result: CustomAssignResult, num_expected: int,
                    **kwargs) -> Union[Tensor, ndarray]:
    ...
    def sample(self, assign_result: CustomAssignResult, pred_instances: InstanceData,
        ...
        if self.add_gt_as_proposals and len(gt_bboxes) > 0:
            ...
            assign_result.add_gt_(gt_labels, gt_ttypes)
