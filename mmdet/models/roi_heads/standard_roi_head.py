...
class StandardRoIHead(BaseRoIHead):
    ...
    def loss(self, x: Tuple[Tensor], rpn_results_list: InstanceList,
        ...
        if self.with_bbox:
            ...
            losses['loss_bbox'] = bbox_results['loss_bbox']
            losses['loss_cls'] = bbox_results['loss_cls']
    ...
    def bbox_loss(self, x: Tuple[Tensor],
        ...
        bbox_results.update(loss_bbox=bbox_loss_and_target['loss_bbox'], loss_cls=bbox_loss_and_target['loss_cls'])
        return bbox_results
