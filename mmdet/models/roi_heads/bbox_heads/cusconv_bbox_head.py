...
class CusConvFCBBoxHead(BBoxHead):
    ...
    def _add_conv_fc_branch(self,
        ...
        if num_branch_convs > 0:
            ...
            for i in range(num_branch_convs):
                ...
                if i!=0:
                    branch_convs.append(nn.MaxPool2d(2,2))
                else:
                    branch_convs.append(nn.MaxPool2d(2,2,1))
        ...
        if num_branch_fcs > 0:
            ...
            for i in range(num_branch_fcs):
                fc_in_channels = 256 # (last_layer_dim if i == 0 else self.fc_out_channels)
                branch_fcs.append(
...
@MODELS.register_module()
class CusShared2FCBBoxHead(CusConvFCBBoxHead):
...
@MODELS.register_module()
class CusShared4Conv1FCBBoxHead(CusConvFCBBoxHead):
