...
class MapConvFCBBoxHead(BBoxHead):
...
@MODELS.register_module()
class MapShared4Conv1FCBBoxHead(MapConvFCBBoxHead):

    def __init__(self, fc_out_channels: int = 256, *args, **kwargs) -> None:
        super().__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
...
@MODELS.register_module()
class MapShared3Conv1FCBBoxHead(MapConvFCBBoxHead):
