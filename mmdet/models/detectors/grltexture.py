...
class GRLTextureDetector(BaseDetector):
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        batch_data_samples[0].gt_instances.ttypes = (batch_data_samples[0].gt_instances.ttypes - 1).clamp(min=-1)
        batch_data_samples[1].gt_instances.ttypes = (batch_data_samples[1].gt_instances.ttypes - 1).clamp(min=-1)
