...
train_pipeline = [
    ...
    dict(
        ...
        [{
            'type':
            'RandomChoiceResize',
            'scales': [(768, 1024), (800, 1024), (832, 1024), (864, 1024), (896, 1024), (928, 1024), (960, 1024), (992, 1024), (1024, 1024)],
            'keep_ratio':
            True
        }],
        [{
                      'type': 'RandomChoiceResize',
                      'scales': [(512, 1024), (640, 1024), (768, 1024)],
                      'keep_ratio': True
                  },], 
        [{
                        'type': 'RandomCrop',
...
txt_pipeline = [
    ...
    dict(type='TextureSG', revjpegpath='/DeepLearning/chenfan_qu/', mins=16, bathres=512),
    dict(type='RandomFlip', prob=0.5),
    dict(
        type='RandomChoice',
        transforms=[
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=1000, by_epoch=False, save_best='auto'),
